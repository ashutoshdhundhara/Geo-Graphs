...
class GG_Response
{
    ...
    {
        $this->_header = new GG_Header();
        $this->_HTML   = '';
        $this->_JSON   = array();
        $this->_footer = new GG_Footer();
        $this->_isAjax     = false;
    ...
    /**
     * Returns the singleton GG_Response object.
     *
     * @return GG_Response object
     */
    public static function getInstance()
    {
        if (empty(self::$_instance)) {
            self::$_instance = new GG_Response();
        }
